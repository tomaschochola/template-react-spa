...
.SILENT: port ports
port ports:
	printf '\033[1m%-80s\033[0m\n' 'template-react-spa ports'
	printf '%-80s\n' '--------------------------------------------------------------------------------'
	printf '\033[1m%-12s %-21s %-12s %-20s\033[0m\n' 'Kind' 'Host' 'Container' 'Service'
	printf '%-12s %-21s %-12s %-20s\n' 'nginx' '127.0.0.1:61000' '61000' 'nginx'
	printf '%-12s %-21s %-12s %-20s\n' 'webpack' '127.0.0.1:61001' '61001' 'devcontainer'
	printf '%-80s\n' '--------------------------------------------------------------------------------'
	printf '\n\033[1mLinks\033[0m\n'
	printf '%s\n' 'Webpack dev server: http://127.0.0.1:61001/'
	printf '%s\n' 'Nginx server:       http://127.0.0.1:61000/'
